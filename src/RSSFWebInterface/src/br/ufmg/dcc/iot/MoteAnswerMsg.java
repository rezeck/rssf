...
public class MoteAnswerMsg extends net.tinyos.message.Message {
    ...
    public MoteAnswerMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new MoteMsg of the given data_length. */
    public MoteAnswerMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }
     ...
     * and base offset.
     */
    public MoteAnswerMsg(int data_length, int base_offset) {
     ...
     * as backing store.
     */
    public MoteAnswerMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public MoteAnswerMsg(byte[] data, int base_offset) {
     ...
     */
    public MoteAnswerMsg(byte[] data, int base_offset, int data_length) {
     ...
     */
    public MoteAnswerMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public MoteAnswerMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
